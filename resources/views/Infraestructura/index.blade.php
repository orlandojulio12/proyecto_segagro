                    ...
                    @forelse($infraestructuras as $infra)
                        <tr>
                            ...
                            <td>
                                <span
                                    class="badge
                                            @if ($infra->estado === 'Pendiente') bg-warning
                                            @elseif($infra->estado === 'En Proceso') bg-info
                                            @elseif($infra->estado === 'Cancelada') bg-danger
                                            @else bg-success @endif
                                        ">
                                    {{ $infra->estado }}
                                </span>
                            ...
                            <td>
                                <div class="action-buttons">
                                    <a href="{{ route('infraestructura.edit', $infra) }}" class="btn btn-sm btn-info"
                                        title="Editar">
