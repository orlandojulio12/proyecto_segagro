...
>>>>>>> af900d9c3a1ee70425c9b1429f51793e13fc29c1
        </a>
    </div>
                ...
                <div class="content-card mb-4">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="contract_number"
                            class="form-control modern-input @error('contract_number') is-invalid @enderror"
                            value="{{ old('contract_number') }}" placeholder="Ej: CT-2025-001" required>
                        @error('contract_number')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                        ...
                        <select name="hiring_modality_id"
                            ...
                            @foreach ($hiringModalities as $modality)
                                <option value="{{ $modality->id }}"
                                    {{ old('hiring_modality_id') == $modality->id ? 'selected' : '' }}>
                                    {{ $modality->modality_name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea name="contract_object" class="form-control modern-input w-100 @error('contract_object') is-invalid @enderror"
                ...
                <div class="content-card mb-4">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="contractor_name"
                            class="form-control modern-input @error('contractor_name') is-invalid @enderror"
                            value="{{ old('contractor_name') }}" placeholder="Nombre completo del contratista" required>
                        @error('contractor_name')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="contractor_nit"
                            class="form-control modern-input @error('contractor_nit') is-invalid @enderror"
                            value="{{ old('contractor_nit') }}" placeholder="Ej: 900123456-7" required>
                        @error('contractor_nit')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="date" name="initial_end_date"
                                    class="form-control modern-input @error('initial_end_date') is-invalid @enderror"
                                    value="{{ old('initial_end_date') }}" required>
                                @error('initial_end_date')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="number" name="initial_value"
                                    class="form-control modern-input @error('initial_value') is-invalid @enderror"
                                    value="{{ old('initial_value') }}" step="0.01" min="0" placeholder="0.00"
                                    required>
                                @error('initial_value')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="number" name="addition_value"
                                    class="form-control modern-input @error('addition_value') is-invalid @enderror"
                                    value="{{ old('addition_value', 0) }}" step="0.01" min="0"
                                    placeholder="0.00">
                                <small class="text-muted">
                                    <i class="fas fa-info-circle"></i> Opcional
                                </small>
