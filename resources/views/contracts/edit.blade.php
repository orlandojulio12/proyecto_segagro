...
<div class="contracts-edit"> {{-- ✅ Wrapper para scope de estilos (NO en body) --}}
                ...
                <div class="content-card mb-4">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="contract_number"
                            ...
                            placeholder="Ej: CT-2025-001" required>
                ...
                <div class="content-card mb-4">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="contractor_nit"
                            ...
                            value="{{ old('contractor_nit', $contract->contractor_nit) }}"
                        ...
                        <select name="contract_type_id" id="contractTypeSelect"
                            ...
                            @foreach ($contractTypes as $type)
                                <option value="{{ $type->id }}"
                                    data-dependencia="{{ $type->dependencia_id }}"
        ...
        <div class="row g-4">
            ...
            <div class="col-6">
                <div class="content-card mb-4">
                    ...
                    {{-- ✅ Componente Centro y Sede con valores pre-cargados --}}
                    <x-centros-sedes-selector
                        :centros="$centros"
                        :required="true"
                        :centroId="old('centro_id', $contract->sede->centro_id ?? null)"
                        :sedeId="old('sede_id', $contract->sede_id)"
                        :centroNombre="old('centro_id') ? '' : ($contract->sede->centro->nom_centro ?? '')"
                        :sedeNombre="old('sede_id') ? '' : ($contract->sede->nom_sede ?? '')"
                    />
                </div>
            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="date" name="initial_end_date"
                                    ...
                                    value="{{ old('initial_end_date', $contract->initial_end_date->format('Y-m-d')) }}" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="initial_value" id="initial_value"
                                    ...
                                    value="{{ old('initial_value', $contract->initial_value) }}"
...
<style>
    ...
    @media (max-width: 768px) {
        .contracts-edit .section-header { flex-direction: column; align-items: flex-start; gap: 15px; }
        .contracts-edit .row > .col-6 { flex: 0 0 100% !important; max-width: 100% !important; }
    }
</style>
@endpush
...
<script>
    ...
    ['initial_value', 'addition_value'].forEach(id => {
        ...
        if (input.value) input.value = formatMoney(input.value.toString());
