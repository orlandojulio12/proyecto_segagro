                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <x-centros-sedes
                            ...
                            :sedeId="old('sede_id', $semoviente->sede_id)"
                            :centroNombre="old('centro_id') ? '' : ($semoviente->centro->nom_centro ?? '')"
                            :sedeNombre="old('sede_id') ? '' : ($semoviente->sede->nom_sede ?? '')"
                        />
                    </div>
                </div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            @if($semoviente->image)
                                <img src="{{ asset('storage/' . $semoviente->image) }}"
                                    alt="Imagen" class="img-fluid mt-2 img-thumbnail" width="150">
                            @endif
                        </div>
                    </div>
                </div>
