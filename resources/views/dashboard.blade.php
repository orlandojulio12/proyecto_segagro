        ...
        <div class="calendar-container">
            ...
            <div class="events-container">
                ...
                @forelse($eventosCalendario->sortBy('date')->take(6) as $evento)
                    <div class="event-item" style="border-left: 4px solid {{ $evento['type_color'] ?? '#22c55e' }}">
...
<style>
    ...
    .stat-card.primary::before { background: linear-gradient(145deg, var(--blue), var(--blue-dark)); }
    .stat-card.success::before { background: linear-gradient(145deg, var(--green), var(--green-dark)); }
    .stat-card.info::before    { background: linear-gradient(145deg, var(--orange), var(--orange-dark)); }
    .stat-card.warning::before { background: linear-gradient(145deg, var(--red), var(--red-dark)); }
    ...
    .stat-card.primary .stat-icon { color: var(--blue); }
    .stat-card.success .stat-icon { color: var(--green); }
    .stat-card.info .stat-icon { color: var(--orange); }
    .stat-card.warning .stat-icon { color: var(--red); }
    ...
    #calendarTitle { font-weight: 700; text-transform: capitalize; }
...
<script>
    ...
    function renderCalendar() {
        ...
        for (let day = 1; day <= lastDate; day++) {
            ...
            grid.innerHTML += `<div class="calendar-day ${isToday?'today':''} ${hasEvent?'has-event':''}">${day}</div>`;
        }
    }
