                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="hidden" name="centro_id_temp" id="centro_id_temp"
                            value="{{ old('centro_id_temp', $user->sedes->first()->centro_id ?? '') }}">
                        <div class="search-box">
                            <input type="text" id="centroSeleccionado"
                                value="{{ old('centro_id_temp', $user->sedes->first()->centro->nom_centro ?? '') }}"
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="hidden" name="sede_id" id="sede_id"
                            value="{{ old('sede_id', $user->sedes->first()->id ?? '') }}">
                        <div class="search-box">
                            <input type="text" id="sedeSeleccionada"
                                value="{{ old('sede_id', $user->sedes->first()->nom_sede ?? '') }}"
                                placeholder="Seleccione una sede..." readonly onclick="openModalSede()" />
